...
import {
  chatReducer,
  initialState,
} from "@/app/dashboard/local-agent/chat-session-reducer";
import { Chat as LocalAgentChat } from "@/components/local-agent-chat/chat";
import { useReducer, useEffect, useRef, useCallback } from "react";
import { useSearchParams, useRouter } from "next/navigation";
import { useChatSessions } from "@/shared/hooks/use-chat-sessions";
import { LOCAL_AGENT_CHAT_APP_ID } from "@/ts/types/ChatAppIds";

export function LocalAgentContainer() {
