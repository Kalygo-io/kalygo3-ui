  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (updatedAgent.config && updatedAgent.config.version === 4) {
        ...
        // Warn if the backend silently dropped any tools (e.g. unsupported type)
        const sentCount = tools.length;
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:opacity-60 disabled:cursor-not-allowed"
                disabled={!isOwner}
              >
