      ...
      <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl overflow-hidden">
        <div className="border-b border-gray-700">
          <div className="flex space-x-1 px-6 pt-6">
            <button
              onClick={() => setActiveTopLevelTab("overview")}
            ...
            <button
              onClick={() => setActiveTopLevelTab("ingestion-logs")}
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium transition-colors ${
                      ...
                      <>
                        <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-4">
                          ...
                          <p className="text-white text-sm leading-relaxed">
                            Upload .txt and .md files. These files will be
                            processed and added to the knowledge base in
                            namespace &quot;
                    ...
                    {!selectedNamespace ? (
                      ...
                      <>
                        <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-4">
                          ...
                          <p className="text-white text-sm leading-relaxed">
                            Upload .csv files with Q&A format (q,a columns).
                            These files will be processed and added to the
                            knowledge base in namespace &quot;
                            {selectedNamespace || "(default)"}&quot;.
                          </p>
                        </div>
                        <ChooseCsvFile
