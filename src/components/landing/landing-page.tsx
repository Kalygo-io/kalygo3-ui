      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center space-x-8">
            ...
            <a
              href="https://github.com/Kalygo-io"
              target="_blank"
              rel="noopener noreferrer"
              className="group p-4 bg-gray-800/50 hover:bg-gradient-to-br hover:from-gray-500/20 hover:to-slate-500/20 rounded-xl border border-gray-700/50 hover:border-gray-500/50 transition-all hover:scale-110 flex items-center justify-center"
              aria-label="GitHub"
            >
              <div className="w-12 h-12 bg-gray-500/20 rounded-lg border border-gray-500/30 flex items-center justify-center">
                <GitHubIcon />
              </div>
            </a>
          </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  aria-label="GitHub"
                >
                  <div className="w-10 h-10 bg-gray-500/20 rounded-lg border border-gray-500/30 flex items-center justify-center">
                    <GitHubIcon />
                  </div>
                </a>
              </div>
